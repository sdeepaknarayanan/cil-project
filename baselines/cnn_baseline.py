...
class ImageDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, images_path, masks_path, device, use_patches=True, resize_to=(400, 400)):
    ...
    def _load_data(self):  # not very scalable, but good enough for now
        self.x = load_all_from_path(self.images_path)[:,:,:,:3]
        self.y = load_all_from_path(self.masks_path)
...
train_dataset = ImageDataset(args.train_image_path, args.train_mask_path, device)
...
# predict on test set
test_path = args.test_image_path
...
create_submission(test_pred, test_filenames, submission_filename=f'{args.name}.csv')